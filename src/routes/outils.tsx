  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="bg-hero border-b border-border/50">
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-16 sm:py-20">
          <div className="inline-flex items-center gap-2 rounded-full border border-primary/30 bg-primary/10 px-3 py-1 text-xs text-primary font-mono mb-6">
            <FlaskConical className="size-3" /> Vague 3 / 3 — complet
          </div>
          ...
          <p className="text-muted-foreground mt-5 max-w-2xl text-lg leading-relaxed">
            Neuf outils interactifs pour PP‑CODEC — paradigme pixel, P3bis, MDL, Hellinger, codeur arithmétique,
            benchmarks, simulateur Poisson NH, pyramide spatiale et inspecteur .ppv. Sans installation, sans WASM.
          </p>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-6 py-16 space-y-12">
        ...
        <HellingerChart lang="fr" />
        <ArithmeticCoder lang="fr" />
        <BenchmarkDashboard lang="fr" />
        <PpSimulator lang="fr" />
        <SpatialPyramid lang="fr" />
        <PpvInspector lang="fr" />
      </div>
      ...
      <footer className="border-t border-border/50">
        <div className="max-w-7xl mx-auto px-6 py-8 text-sm text-muted-foreground flex flex-wrap items-center justify-between gap-3">
          <span className="font-mono text-xs">PP‑CODEC FORGE · Outils v3 · Vague 3/3</span>
